...
const Projects = () => {
  ...
  const projects = [
    ...
    },
    {
      ...
      preview: 'https://raw.githubusercontent.com/AadityaUoHyd/library-book-network/refs/heads/main/Screenshot.png',
      github: 'https://github.com/AadityaUoHyd/library-book-network',
      live: 'https://library-book-network.vercel.app',
      filters: ['filter-app'],
      gallery: 'portfolio-gallery-app',
    },
    {
