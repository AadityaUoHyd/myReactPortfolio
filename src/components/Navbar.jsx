      ...
      <div className=' max-w-7xl mx-auto flex h-14 items-center'>
        <div className='md:mr-4 flex justify-between w-full'>
            ...
            <nav className='md:flex hidden items-center space-x-6 text-lg font-medium'>
                <a href="#about" className='transition-colors hover:text-foreground/80 text-foreground/60 hover:text-red-500'>About</a>
                <a href="#projects" className='transition-colors hover:text-foreground/80 text-foreground/60 hover:text-red-500'>Projects</a>
                <a href="#testimonials" className='transition-colors hover:text-foreground/80 text-foreground/60 hover:text-red-500'>Testimonials</a>
                <a href="#contact" className='transition-colors hover:text-foreground/80 text-foreground/60 hover:text-red-500'>Contact</a>
            </nav>
        </div>
